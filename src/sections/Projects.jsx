                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  {project.link && (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="p-2 rounded-lg glass-effect hover:bg-primary-500/10 transition-colors"
                    >
                  ...
                  >
                    {project.achievements.map((achievement, idx) => (
                      <motion.div
                        ...
                        className="flex items-start gap-3 p-3 rounded-lg bg-primary-50/50 dark:bg-primary-900/20 border border-primary-200/50 dark:border-primary-800/50"
                      >
                ...
                <div className={`flex flex-wrap gap-2 ${project.link ? 'mb-6' : 'mb-0'}`}>
                  {project.technologies.map((tech, idx) => (
                    <motion.span
                      ...
                      className="px-4 py-1.5 bg-gradient-to-r from-primary-100 to-accent-100 dark:from-primary-900/40 dark:to-accent-900/40 text-primary-700 dark:text-primary-300 rounded-full text-xs font-semibold border border-primary-200/50 dark:border-primary-800/50"
                    >
                      {tech}
                    </motion.span>
                  ))}
