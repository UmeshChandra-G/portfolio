            ...
            >
              ...
              <div className="relative premium-card flex items-center gap-6">
                <motion.div
                  ...
                  className="p-5 bg-gradient-to-br from-primary-500 via-accent-500 to-primary-600 rounded-2xl shadow-xl flex-shrink-0"
                >
                ...
                >
                  <Award className="w-6 h-6 text-primary-400/50" />
                </motion.div>
              </div>
            </motion.div>
          ))}
